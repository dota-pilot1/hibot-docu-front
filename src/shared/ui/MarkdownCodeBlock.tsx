...
export const MarkdownCodeBlock = ({ inline, className, children, ...props }: MarkdownCodeBlockProps) => {
    ...
    return (
        <div className="relative group my-5 overflow-hidden bg-gray-950 rounded-lg">
            <div className="flex items-center justify-between !px-5 py-1.5 bg-gray-900 border-b border-gray-800">
            ...
            <pre className={`!py-3 !px-6 overflow-x-auto text-sm font-mono leading-relaxed text-gray-300 bg-transparent m-0 ${className || ''}`} {...props}>
                <code>{children}</code>
            </pre>
        </div>
    );
