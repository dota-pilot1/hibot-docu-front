        ...
        <div className="space-y-4">
                                        ...
                                        {content.content && (
                                            <CardContent>
                                                <div className="relative max-h-[160px] overflow-hidden transition-all duration-300">
                                                    <div className="prose prose-sm max-w-none dark:prose-invert prose-pre:bg-transparent prose-code:before:content-none prose-code:after:content-none prose-code:bg-transparent prose-code:border-none prose-code:p-0">
                                                        <ReactMarkdown
            ...
            <Dialog open={isViewModalOpen} onOpenChange={setIsViewModalOpen}>
                <DialogContent className="sm:max-w-4xl max-h-[90vh] overflow-y-auto">
                    ...
                    <div className="py-4">
                        <div className="prose prose-sm max-w-none dark:prose-invert prose-pre:bg-transparent prose-code:before:content-none prose-code:after:content-none prose-code:bg-transparent prose-code:border-none prose-code:p-0 font-sans">
                            <ReactMarkdown
                                remarkPlugins={[remarkGfm, remarkBreaks]}
                                components={{
                                    code: MarkdownCodeBlock as any
