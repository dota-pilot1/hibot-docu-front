...
export const FooterBody = forwardRef<HTMLDivElement, FooterBodyProps>(
  ({ isExpanded, activeTab, notifications, height, isResizing }, ref) => {
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "bg-zinc-50 dark:bg-zinc-900/50 border-t border-zinc-200 dark:border-zinc-800 overflow-y-auto p-4",
